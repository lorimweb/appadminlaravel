        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-shopping-cart"></span> Cadastro de Produtos</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <form class="" action="/produtos/inserir" method="post">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="qtdade" value="{{old('qtdade')}}">
